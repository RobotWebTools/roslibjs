/**
 * @param {SharedWorkerGlobalScope} self 
 */
module.exports = function (sharedWorkerGlobalScope) {
    console.log('Attaching Shared Worker : ' + self);
     ...
     * @param {MessageEvent} messageEvent
     */
    function onConnect(messageEvent) {
    ...
    sharedWorkerGlobalScope.addEventListener('connect', onConnect);
};