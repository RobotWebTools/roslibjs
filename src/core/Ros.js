 ...
 * @param {string} [options.transportLibrary=websocket] - One of 'websocket', 'workersocket', 'socket.io', 'sharedworker' (only on browser) or RTCPeerConnection instance controlling how the connection is created in `connect`.
